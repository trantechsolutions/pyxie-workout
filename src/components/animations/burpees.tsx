...
export function BurpeesAnimation({ size = 'md' }: { size?: AnimationSize }) {
  return (
    <AnimationBase size={size} className="anim-burpees"><rect x="4" y="58" width="56" height="2" fill="var(--border)" />
