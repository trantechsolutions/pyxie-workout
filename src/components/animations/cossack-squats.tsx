...
export function CossackSquatsAnimation({ size = 'md' }: { size?: AnimationSize }) {
  return (
    <AnimationBase size={size} className="anim-cossack-squats">
  ...
  <g className="anim-frame anim-frame-a">
    ...
    <rect x="21" y="28" width="4" height="28" fill="var(--text)" />
    <rect x="39" y="28" width="4" height="28" fill="var(--text)" />
  </g>
  <g className="anim-frame anim-frame-b">
    ...
    <rect x="10" y="36" width="6" height="6" fill="var(--text)" />
    <rect x="48" y="36" width="6" height="6" fill="var(--text)" />
    <rect x="10" y="42" width="4" height="14" fill="var(--text)" />
    <rect x="50" y="42" width="4" height="14" fill="var(--text)" />
    <rect x="46" y="34" width="2" height="6" fill="var(--gold)" /><rect x="44" y="38" width="6" height="2" fill="var(--gold)" />
  </g>
    </AnimationBase>
  );
}
