...
export function SpiderPlankAnimation({ size = 'md' }: { size?: AnimationSize }) {
  return (
    <AnimationBase size={size} className="anim-spider-plank">
    ...
    <g className="anim-frame anim-frame-a">
      <rect x="20" y="40" width="3" height="5" fill="var(--text)" />
      <rect x="20" y="44" width="8" height="3" fill="var(--text)" />
    ...
    <g className="anim-frame anim-frame-b">
      <rect x="14" y="40" width="3" height="8" fill="var(--text-dim)" />
      <rect x="46" y="40" width="3" height="5" fill="var(--text)" />
      <rect x="42" y="44" width="8" height="3" fill="var(--text)" />
      <rect x="50" y="38" width="8" height="3" fill="var(--text)" />
    </g>
    </AnimationBase>
  );
