...
export function SingleLegBurpeeAnimation({ size = 'md' }: { size?: AnimationSize }) {
  return (
    <AnimationBase size={size} className="anim-single-leg-burpee"><rect x="4" y="58" width="56" height="2" fill="var(--border)" />
