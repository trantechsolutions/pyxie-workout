...
export function PushUpBurpeeAnimation({ size = 'md' }: { size?: AnimationSize }) {
  return (
    <AnimationBase size={size} className="anim-push-up-burpee"><rect x="4" y="58" width="56" height="2" fill="var(--border)" />
    ...
    <g className="anim-burpee-frame anim-burpee-3">
      <rect x="8" y="40" width="6" height="6" fill="var(--gold)" />
      <rect x="14" y="44" width="32" height="4" fill="var(--text)" />
      <rect x="46" y="44" width="4" height="4" fill="var(--text)" />
      <rect x="14" y="48" width="14" height="4" fill="var(--text-dim)" />
      <rect x="50" y="46" width="8" height="3" fill="var(--text)" /><rect x="56" y="49" width="3" height="5" fill="var(--text-dim)" />
    </g>
