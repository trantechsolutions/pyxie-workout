...
export function BurpeeBroadJumpAnimation({ size = 'md' }: { size?: AnimationSize }) {
  return (
    <AnimationBase size={size} className="anim-burpee-broad-jump"><rect x="4" y="58" width="56" height="2" fill="var(--border)" />
    ...
    <g className="anim-burpee-frame anim-burpee-4">
      <rect x="44" y="20" width="8" height="8" fill="var(--gold)" />
      <rect x="45" y="28" width="6" height="10" fill="var(--text)" />
      <rect x="38" y="22" width="3" height="10" fill="var(--text-dim)" />
      <rect x="55" y="22" width="3" height="10" fill="var(--text-dim)" />
      <rect x="43" y="38" width="4" height="8" fill="var(--text)" />
      <rect x="51" y="38" width="4" height="8" fill="var(--text)" />
      <rect x="6" y="54" width="50" height="2" fill="var(--gold)" />
    </g>
    </AnimationBase>
  );
}
