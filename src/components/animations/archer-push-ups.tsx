...
export function ArcherPushUpsAnimation({ size = 'md' }: { size?: AnimationSize }) {
  return (
    <AnimationBase size={size} className="anim-archer-push-ups">
  ...
  <g className="anim-frame anim-frame-a">
    ...
    <rect x="20" y="38" width="3" height="10" fill="var(--text-dim)" />
  ...
  <g className="anim-frame anim-frame-b">
    ...
    <rect x="20" y="44" width="3" height="4" fill="var(--text-dim)" />
    <rect x="17" y="45" width="3" height="3" fill="var(--text-dim)" />
