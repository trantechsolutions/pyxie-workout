...
export function PlankUpDownsAnimation({ size = 'md' }: { size?: AnimationSize }) {
  return (
    <AnimationBase size={size} className="anim-plank-up-downs">
    ...
    <g className="anim-burpee-frame anim-burpee-2">
      <rect x="8" y="34" width="6" height="6" fill="var(--gold)" />
      <rect x="14" y="38" width="32" height="4" fill="var(--text)" />
      <rect x="46" y="38" width="4" height="4" fill="var(--text)" />
      <rect x="14" y="42" width="3" height="6" fill="var(--text-dim)" />
    ...
    <g className="anim-burpee-frame anim-burpee-4">
      ...
      <rect x="14" y="38" width="32" height="4" fill="var(--text)" />
      <rect x="46" y="38" width="4" height="4" fill="var(--text)" />
      <rect x="14" y="42" width="6" height="4" fill="var(--text-dim)" />
      <rect x="22" y="42" width="3" height="6" fill="var(--text-dim)" />
      <rect x="50" y="40" width="8" height="3" fill="var(--text)" />
    </g>
    </AnimationBase>
  );
