...
export function SingleLegGluteBridgeAnimation({ size = 'md' }: { size?: AnimationSize }) {
  return (
    <AnimationBase size={size} className="anim-single-leg-glute-bridge">
  ...
  <g className="anim-frame anim-frame-a">
    ...
    <rect x="46" y="20" width="4" height="28" fill="var(--text)" />
  </g>
