...
export function MountainClimbersAnimation({ size = 'md' }: { size?: AnimationSize }) {
  return (
    <AnimationBase size={size} className="anim-mountain-climbers">
  ...
  <g className="anim-frame anim-frame-b">
    ...
    <rect x="50" y="40" width="8" height="3" fill="var(--text)" />
    <rect x="46" y="46" width="3" height="3" fill="var(--text)" />
  </g>
    </AnimationBase>
  );
}
